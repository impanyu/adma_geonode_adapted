...
RUN mkdir -p /usr/src/adma_geonode_project
...
COPY src /usr/src/adma_geonode_project/
WORKDIR /usr/src/adma_geonode_project
...
RUN chmod +x /usr/src/adma_geonode_project/tasks.py \
    && chmod +x /usr/src/adma_geonode_project/entrypoint.sh
...
# ENTRYPOINT /usr/src/adma_geonode_project/entrypoint.sh
